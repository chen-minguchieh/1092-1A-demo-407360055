...
function changeImage(index) {
    ...
    switch (index) {
        case 1:
            player.innerHTML =`<img src="./img1.png" style="width: 100%; height: auto" alt="">`;
      break;
        case 2:
            player.innerHTML =`<img src="./img2.png" style="width: 100%; height: auto" alt="">`;
      break;
        case 3:
            player.innerHTML =`<img src="./img3.png" style="width: 100%; height: auto" alt="">`;
      break;
        case 4:
            player.innerHTML =`<img src="./img4.png" style="width: 100%; height: auto" alt="">`;
      break;
        case 5:
            player.innerHTML =`<img src="./img5.png" style="width: 100%; height: auto" alt="">`;
      break;
    }
}